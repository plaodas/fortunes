    ...
    expect_result = {
        "四柱": {
            "年柱": {
                ...
                "干支": "乙卯",
                "領域": (
                    "家系・幼少期・ルーツに影響。家族の価値観や幼少期の性質を示す。"
                ),
                "十干の性質": "柔らかく調和的。人間関係に強い。",
                "十二支の性質": "社交性と調和。人間関係に恵まれる。",
                "まとめ": (
                    "年柱は家系・幼少期・ルーツに影響。家族の価値観や幼少期の性質を示す。"
                    "。柔らかく調和的。人間関係に強い。、社交性と調和。人間関係に恵まれる。の性質が強く表れる。"
                ),
            },
            "月柱": {
                "柱": "月柱",
                "干支": "戊寅",
                "領域": (
                    "社会・青年期・仕事運に影響。20〜40代の運勢や社会的立場を示す。"
                ),
                "十干の性質": "安定感があり、責任感が強い。",
                "十二支の性質": "行動力と勇気。リーダーシップ。",
                "まとめ": (
                    "月柱は社会・青年期・仕事運に影響。20〜40代の運勢や社会的立場を示す。"
                    "。安定感があり、責任感が強い。、行動力と勇気。リーダーシップ。の性質が強く表れる。"
                ),
            },
            "日柱": {
                "柱": "日柱",
                ...
                "まとめ": (
                    "日柱は本人の本質・性格・結婚運を示す。人生の中心となる柱。"
                    "。美意識が高く、繊細でこだわりが強い。、情熱と探究心。精神性が強い。の性質が強く表れる。"
                ),
            },
            "時柱": {
                "柱": "時柱",
