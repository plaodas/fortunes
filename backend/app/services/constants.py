...
TOUGEN_FORTUNE = {
    "大吉": {
        ...
        "長文": "桃源の山々に朝日が差し込み、柔らかな光があなたの歩む道を照らしています。努力は実り、出会いは恵みとなり、"
        "運命はあなたに味方するでしょう。迷いが晴れ、心のままに進むほどに景色は美しく広がります。",
    },
    "吉": {
        "短文": "穏やかな追い風が吹き、歩みは自然と前へ進む。",
        "長文": "桃源の小径を歩けば、草木がそよぎ、鳥たちが優しく歌います。大きな飛躍ではないものの、" "確かな前進が感じられる時期。心を整え、自然の流れに身を任せれば、道はゆるやかに開けていきます。",
    },
    "半吉": {
    ...
    "凶": {
        ...
        "長文": "桃源の空に雲がかかり、風が少し荒れています。無理に進もうとすると枝に引っかかり、思わぬつまずきが生じることも。"
        "しかし、立ち止まり、周囲を見渡せば、避けるべき道と進むべき道が見えてきます。",
    },
    "大凶": {
        "短文": "嵐の前触れ。今は動かず、心を守る時。",
        "長文": "桃源の山々に黒雲が集まり、激しい雨の気配が漂っています。この時期は無理に進まず、洞窟で雨宿りする旅人のように、心と体を守ることが最優先。"
